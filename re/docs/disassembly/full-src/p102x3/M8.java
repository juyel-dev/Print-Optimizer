...
public final class M8 implements e {
    ...
    public final /* synthetic */ State f14196o;
    public final /* synthetic */ State p;
    public final /* synthetic */ MutableState q;

    /* JADX INFO: renamed from: r, reason: collision with root package name */
    public final /* synthetic */ MutableState f14197r;

    public M8(State state, State state2, MutableState mutableState, MutableState mutableState2) {
        this.f14196o = state;
        this.p = state2;
        this.q = mutableState;
        this.f14197r = mutableState2;
    }
    ...
    public final Object invoke(Object obj, Object obj2) {
        ...
        if ((iIntValue & 3) == 2 && composer.getSkipping()) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(29436928, iIntValue, -1, "com.notescrafter.ui.screens.PdfMergeScreen.<anonymous> (PdfMergeScreen.kt:958)");
            }
            ...
            Modifier modifierClip = ClipKt.clip(SizeKt.m713size3ABfNKs(companion, Dp.m6403constructorimpl(((Number) this.f14196o.getValue()).floatValue() * 80)), RoundedCornerShapeKt.getCircleShape());
            ...
            IconKt.m1877Iconww6aTOc(callMerge, (String) null, SizeKt.m713size3ABfNKs(companion, Dp.m6403constructorimpl(28)), companion5.m3964getWhite0d7_KjU(), composer, 3504, 0);
            ...
            composer.startReplaceGroup(755429197);
            Object objRememberedValue = composer.rememberedValue();
            Object empty = Composer.Companion.getEmpty();
            MutableState mutableState = this.f14197r;
            if (objRememberedValue == empty) {
                objRememberedValue = new O6(10, mutableState);
