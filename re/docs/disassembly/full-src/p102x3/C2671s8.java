...
/* JADX INFO: renamed from: x3.s8, reason: case insensitive filesystem */
/* JADX INFO: loaded from: classes2.dex */
public final class C2671s8 extends j implements e {

    /* JADX INFO: renamed from: o, reason: collision with root package name */
    public final /* synthetic */ Context f15525o;
    public final /* synthetic */ Uri p;
    public final /* synthetic */ int q;

    /* JADX INFO: renamed from: r, reason: collision with root package name */
    public final /* synthetic */ MutableState f15526r;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2671s8(Context context, Uri uri, int i5, MutableState mutableState, d dVar) {
        super(2, dVar);
        this.f15525o = context;
        this.p = uri;
        this.q = i5;
        this.f15526r = mutableState;
    }

    @Override // H3.a
    public final d create(Object obj, d dVar) {
        return new C2671s8(this.f15525o, this.p, this.q, this.f15526r, dVar);
    }

    @Override // O3.e
    public final Object invoke(Object obj, Object obj2) throws Throwable {
        C2671s8 c2671s8 = (C2671s8) create((InterfaceC0200y) obj, (d) obj2);
        o oVar = o.f154a;
        c2671s8.invokeSuspend(oVar);
        return oVar;
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        try {
            try {
                parcelFileDescriptorOpenFileDescriptor = this.f15525o.getContentResolver().openFileDescriptor(this.p, "r");
                        ...
                        try {
                            ...
                            if (i5 < pageCount) {
                                ...
                                try {
                                    ...
                                    this.f15526r.setValue(bitmapCreateBitmap);
                                    pageOpenPage.close();
                                } catch (Throwable th2) {
                                    pageOpenPage.close();
                                    throw th2;
