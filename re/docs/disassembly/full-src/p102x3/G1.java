...
public final class G1 implements f {
    ...
    public static final G1 f13973o = new G1();
    ...
    public final Object invoke(Object obj, Object obj2, Object obj3) {
        ...
        if ((iIntValue & 17) == 16 && composer.getSkipping()) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-312612193, iIntValue, -1, "com.notescrafter.ui.screens.ComposableSingletons$PdfSplitScreenKt.lambda-4.<anonymous> (PdfSplitScreen.kt:668)");
            }
            ...
            C9.b("01", DescriptionKt.getDescription(outlined), "Select PDF Document", "Choose the PDF file you want to split from your device storage.", composer, 3462);
            C9.b("02", GridViewKt.getGridView(outlined), "Choose Split Mode", "Select Extract Pages, Split All (page-by-page), or Every N Pages.", composer, 3462);
            C9.b("03", CallSplitKt.getCallSplit(Icons.AutoMirrored.Outlined.INSTANCE), "Execute Split", "Specify the ranges or split parameters and click 'Split PDF' to run.", composer, 3462);
            composer.endNode();
            if (ComposerKt.isTraceInProgress()) {
