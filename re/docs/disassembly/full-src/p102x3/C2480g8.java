...
/* JADX INFO: renamed from: x3.g8, reason: case insensitive filesystem */
/* JADX INFO: loaded from: classes2.dex */
public final class C2480g8 implements f {

    /* JADX INFO: renamed from: o, reason: collision with root package name */
    public final /* synthetic */ MutableState f15083o;
    public final /* synthetic */ MutableState p;
    public final /* synthetic */ Context q;

    /* JADX INFO: renamed from: r, reason: collision with root package name */
    public final /* synthetic */ MutableState f15084r;

    /* JADX INFO: renamed from: s, reason: collision with root package name */
    public final /* synthetic */ MutableState f15085s;
    public final /* synthetic */ MutableState t;

    public C2480g8(Context context, MutableState mutableState, MutableState mutableState2, MutableState mutableState3, MutableState mutableState4, MutableState mutableState5) {
        this.f15083o = mutableState;
        this.p = mutableState2;
        this.q = context;
        this.f15084r = mutableState3;
        this.f15085s = mutableState4;
    ...
    public final Object invoke(Object obj, Object obj2, Object obj3) {
        ...
        if ((iIntValue & 17) == 16 && composer.getSkipping()) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1954512227, iIntValue, -1, "com.notescrafter.ui.screens.PdfInvertScreen.<anonymous>.<anonymous>.<anonymous>.<anonymous> (PdfInvertScreen.kt:342)");
            }
            ...
            MutableState mutableState = this.f15083o;
            j.a(modifierM672paddingqDBjuR0$default, 0L, jM3926copywmQWz5c$default, 0.0f, null, ComposableLambdaKt.rememberComposableLambda(-571078430, true, new C2464f8(this.q, mutableState, this.p), composer, 54), composer, 196998, 26);
            SpacerKt.Spacer(SizeKt.m699height3ABfNKs(companion, Dp.m6403constructorimpl(32)), composer, 6);
            composer.startReplaceGroup(338707267);
            Object objRememberedValue = composer.rememberedValue();
            if (objRememberedValue == Composer.Companion.getEmpty()) {
                objRememberedValue = new C2527j7(this.f15084r, this.f15085s, mutableState, this.t, 2);
                composer.updateRememberedValue(objRememberedValue);
            }
            composer.endReplaceGroup();
            ButtonKt.TextButton((a) objRememberedValue, null, false, null, null, null, null, null, null, AbstractC2489h1.f15136d, composer, 805306374, 510);
            composer.endNode();
            if (ComposerKt.isTraceInProgress()) {
