...
/* JADX INFO: renamed from: x3.h0, reason: case insensitive filesystem */
/* JADX INFO: loaded from: classes2.dex */
public final class C2488h0 implements f {

    /* JADX INFO: renamed from: o, reason: collision with root package name */
    public static final C2488h0 f15132o = new C2488h0();
    ...
    public final Object invoke(Object obj, Object obj2, Object obj3) {
        ...
        if ((iIntValue & 17) == 16 && composer.getSkipping()) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(1499459423, iIntValue, -1, "com.notescrafter.ui.screens.ComposableSingletons$JpgToPdfScreenKt.lambda-6.<anonymous> (JpgToPdfScreen.kt:637)");
            }
            ...
            AbstractC2494h6.b("01", ImageKt.getImage(outlined), "Select Images", "Choose one or multiple JPEG/PNG/WEBP images from your device gallery.", composer, 3462);
            AbstractC2494h6.b("02", SettingsKt.getSettings(outlined), "Configure & Reorder", "Select page sizes (A4, Letter, Fit to image), layout orientation, or rearrange slide indices.", composer, 3462);
            AbstractC2494h6.b("03", PictureAsPdfKt.getPictureAsPdf(outlined), "Compile PDF", "Tap 'Convert to PDF' to compile images offline into a single document.", composer, 3462);
            composer.endNode();
            if (ComposerKt.isTraceInProgress()) {
