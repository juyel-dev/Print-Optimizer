...
public final class O7 implements f {

    /* JADX INFO: renamed from: o, reason: collision with root package name */
    public final /* synthetic */ InterfaceC0200y f14256o;
    public final /* synthetic */ Context p;
    public final /* synthetic */ MutableState q;

    /* JADX INFO: renamed from: r, reason: collision with root package name */
    public final /* synthetic */ MutableState f14257r;

    /* JADX INFO: renamed from: s, reason: collision with root package name */
    public final /* synthetic */ MutableState f14258s;
    public final /* synthetic */ MutableState t;

    public O7(InterfaceC0200y interfaceC0200y, Context context, MutableState mutableState, MutableState mutableState2, MutableState mutableState3, MutableState mutableState4) {
        this.f14256o = interfaceC0200y;
        this.p = context;
        this.q = mutableState;
        this.f14257r = mutableState2;
        this.f14258s = mutableState3;
    ...
    public final Object invoke(Object obj, Object obj2, Object obj3) {
        ...
        if ((iIntValue & 17) == 16 && composer.getSkipping()) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1835885831, iIntValue, -1, "com.notescrafter.ui.screens.PdfCropScreen.<anonymous>.<anonymous>.<anonymous>.<anonymous>.<anonymous> (PdfCropScreen.kt:924)");
            }
            ...
            composer.startReplaceGroup(2131222553);
            InterfaceC0200y interfaceC0200y = this.f14256o;
            ...
            MutableState mutableState3 = this.f14257r;
            MutableState mutableState4 = this.f14258s;
            MutableState mutableState5 = this.t;
            if (zChangedInstance2 || objRememberedValue == Composer.Companion.getEmpty()) {
                mutableState = mutableState5;
                L7 l7 = new L7(mutableState2, mutableState3, mutableState4, interfaceC0200y, context, mutableState, 0);
            ...
            IconButtonKt.IconButton((a) objRememberedValue, modifierM207backgroundbw27NRU$default, z3, null, null, ComposableLambdaKt.rememberComposableLambda(-625961990, true, new M7(mutableState2), composer, 54), composer, 196608, 24);
            float f6 = 16;
            SpacerKt.Spacer(SizeKt.m718width3ABfNKs(companion, Dp.m6403constructorimpl(f6)), composer, 6);
            String strM = p035i0.a.m("Page ", " of ", ((Number) mutableState2.getValue()).intValue(), AbstractC2416c8.b(mutableState4));
            ...
            composer.startReplaceGroup(2131262073);
            ...
            if (zChangedInstance3 || objRememberedValue2 == Composer.Companion.getEmpty()) {
                L7 l8 = new L7(mutableState2, mutableState3, mutableState4, interfaceC0200y, context, mutableState, 1);
                composer.updateRememberedValue(l8);
                objRememberedValue2 = l8;
            }
            composer.endReplaceGroup();
            IconButtonKt.IconButton((a) objRememberedValue2, modifierM207backgroundbw27NRU$default2, z4, null, null, ComposableLambdaKt.rememberComposableLambda(-1336166607, true, new N7(mutableState2, mutableState4), composer, 54), composer, 196608, 24);
            composer.endNode();
            if (ComposerKt.isTraceInProgress()) {
