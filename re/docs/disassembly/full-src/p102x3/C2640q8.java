...
/* JADX INFO: renamed from: x3.q8, reason: case insensitive filesystem */
/* JADX INFO: loaded from: classes2.dex */
public final class C2640q8 implements f {

    /* JADX INFO: renamed from: o, reason: collision with root package name */
    public final /* synthetic */ InterfaceC0200y f15439o;
    public final /* synthetic */ PDFProcessor p;
    public final /* synthetic */ Context q;

    /* JADX INFO: renamed from: r, reason: collision with root package name */
    public final /* synthetic */ MutableState f15440r;

    /* JADX INFO: renamed from: s, reason: collision with root package name */
    public final /* synthetic */ MutableState f15441s;
    public final /* synthetic */ MutableState t;
    public final /* synthetic */ MutableState u;

    /* JADX INFO: renamed from: v, reason: collision with root package name */
    public final /* synthetic */ MutableState f15442v;

    /* JADX INFO: renamed from: w, reason: collision with root package name */
    public final /* synthetic */ MutableState f15443w;

    /* JADX INFO: renamed from: x, reason: collision with root package name */
    public final /* synthetic */ MutableState f15444x;

    /* JADX INFO: renamed from: y, reason: collision with root package name */
    public final /* synthetic */ MutableState f15445y;

    public C2640q8(InterfaceC0200y interfaceC0200y, Context context, MutableState mutableState, MutableState mutableState2, MutableState mutableState3, MutableState mutableState4, MutableState mutableState5, MutableState mutableState6, MutableState mutableState7, MutableState mutableState8, PDFProcessor pDFProcessor) {
        this.f15439o = interfaceC0200y;
        this.p = pDFProcessor;
        this.q = context;
        this.f15440r = mutableState;
        this.f15441s = mutableState2;
        this.t = mutableState3;
        this.u = mutableState4;
        this.f15442v = mutableState5;
        this.f15443w = mutableState6;
        this.f15444x = mutableState7;
        this.f15445y = mutableState8;
    }
    ...
    public final Object invoke(Object obj, Object obj2, Object obj3) {
        ...
        if ((iIntValue & 17) == 16 && composer2.getSkipping()) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(482398969, iIntValue, -1, "com.notescrafter.ui.screens.PdfInvertScreen.<anonymous>.<anonymous>.<anonymous>.<anonymous> (PdfInvertScreen.kt:862)");
            }
            String str = (String) this.f15440r.getValue();
            composer2.startReplaceGroup(-67843501);
            if (str == null) {
                composer = composer2;
            } else {
            ...
            composer3.startReplaceGroup(-67824136);
            boolean zChangedInstance = composer3.changedInstance(this.f15439o) | composer3.changedInstance(this.p) | composer3.changedInstance(this.q);
            Object objRememberedValue = composer3.rememberedValue();
            if (zChangedInstance || objRememberedValue == Composer.Companion.getEmpty()) {
                final MutableState mutableState = this.f15440r;
                final MutableState mutableState2 = this.f15443w;
                final InterfaceC0200y interfaceC0200y = this.f15439o;
                final MutableState mutableState3 = this.f15441s;
                ...
                final MutableState mutableState6 = this.f15442v;
                final MutableState mutableState7 = this.f15444x;
                final MutableState mutableState8 = this.f15445y;
                objRememberedValue = new a() { // from class: x3.p8
                    /* JADX WARN: Multi-variable type inference failed */
                    @Override // O3.a
                    public final Object invoke() {
                        ...
                        if (uri != null) {
                            ...
                            if (AbstractC2783z8.b(mutableState9) > 0) {
                                A.t(interfaceC0200y, null, null, new C2751x8(null, context, uri, mutableState5, mutableState6, mutableState, mutableState2, mutableState7, mutableState8, mutableState9, pDFProcessor), 3);
                            }
                        }
                        return B3.o.f154a;
                    }
            ...
            q.a("Invert Colors", (a) objRememberedValue, SizeKt.fillMaxWidth$default(Modifier.Companion, 0.0f, 1, null), null, false, false, composer3, 390, 56);
            if (ComposerKt.isTraceInProgress()) {
