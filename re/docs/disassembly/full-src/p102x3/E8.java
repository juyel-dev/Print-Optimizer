...
public final class E8 implements f {
    ...
    public final /* synthetic */ Context f13918o;
    public final /* synthetic */ MutableState p;
    public final /* synthetic */ MutableState q;

    /* JADX INFO: renamed from: r, reason: collision with root package name */
    public final /* synthetic */ int f13919r;

    /* JADX INFO: renamed from: s, reason: collision with root package name */
    public final /* synthetic */ MutableState f13920s;
    public final /* synthetic */ MutableState t;

    public E8(Context context, MutableState mutableState, MutableState mutableState2, int i5, MutableState mutableState3, MutableState mutableState4) {
        this.f13918o = context;
        this.p = mutableState;
        this.q = mutableState2;
        this.f13919r = i5;
        this.f13920s = mutableState3;
    ...
    public final Object invoke(Object obj, Object obj2, Object obj3) {
        ...
        if ((iIntValue & 17) == 16 && composer.getSkipping()) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(1887306427, iIntValue, -1, "com.notescrafter.ui.screens.PdfMergeScreen.<anonymous>.<anonymous>.<anonymous>.<anonymous> (PdfMergeScreen.kt:275)");
            }
            ...
            TextKt.m2432Text4IGK_g("Merged Successfully!", (Modifier) null, j6, 0L, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, TextAlign.m6285boximpl(companion4.m6292getCentere0LSkKk()), 0L, 0, false, 0, 0, (c) null, textStyleM5917copyp1EtxEg, composer, 390, 0, 65018);
            b.m(8, companion, composer, 6);
            TextKt.m2432Text4IGK_g("Your combined document is ready to use", (Modifier) null, p107y3.a.p, 0L, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, TextAlign.m6285boximpl(companion4.m6292getCentere0LSkKk()), 0L, 0, false, 0, 0, (c) null, materialTheme.getTypography(composer, i5).getBodyMedium(), composer, 390, 0, 65018);
            b.m(28, companion, composer, 6);
            Modifier modifierFillMaxWidth$default = SizeKt.fillMaxWidth$default(companion, 0.0f, 1, null);
            long jM3926copywmQWz5c$default = Color.m3926copywmQWz5c$default(j5, 0.15f, 0.0f, 0.0f, 0.0f, 14, null);
            MutableState mutableState2 = this.p;
            j.a(modifierFillMaxWidth$default, 0L, jM3926copywmQWz5c$default, 0.0f, null, ComposableLambdaKt.rememberComposableLambda(-524659136, true, new D8(this.f13919r, mutableState2, this.q), composer, 54), composer, 196998, 26);
            SpacerKt.Spacer(SizeKt.m699height3ABfNKs(companion, Dp.m6403constructorimpl(32)), composer, 6);
            composer.startReplaceGroup(-84965294);
            Context context = this.f13918o;
            boolean zChangedInstance = composer.changedInstance(context);
            Object objRememberedValue = composer.rememberedValue();
            if (zChangedInstance || objRememberedValue == Composer.Companion.getEmpty()) {
                objRememberedValue = new M5(context, mutableState2, 10);
                composer.updateRememberedValue(objRememberedValue);
            }
            composer.endReplaceGroup();
            q.a("Open PDF", (a) objRememberedValue, SizeKt.fillMaxWidth$default(companion, 0.0f, 1, null), null, false, false, composer, 390, 56);
            ...
            composer.startReplaceGroup(-84931732);
            ...
            if (zChangedInstance2 || objRememberedValue2 == Composer.Companion.getEmpty()) {
                ...
                objRememberedValue2 = new M5(context, mutableState, 11);
            ...
            ButtonKt.OutlinedButton((a) objRememberedValue2, modifierM699height3ABfNKs, false, roundedCornerShapeM955RoundedCornerShape0680j_4, buttonColorsM1530outlinedButtonColorsro_MJ88, null, borderStrokeM236BorderStrokecXLIe8U, null, null, AbstractC2648r1.f15466b, composer, 806879280, 420);
            SpacerKt.Spacer(SizeKt.m699height3ABfNKs(companion, Dp.m6403constructorimpl(f5)), composer, 6);
            composer.startReplaceGroup(-84882742);
            Object objRememberedValue3 = composer.rememberedValue();
            if (objRememberedValue3 == Composer.Companion.getEmpty()) {
                objRememberedValue3 = new P3(3, this.f13920s, mutableState3, this.t);
                composer.updateRememberedValue(objRememberedValue3);
            }
            composer.endReplaceGroup();
            ButtonKt.TextButton((a) objRememberedValue3, null, false, null, null, null, null, null, null, AbstractC2648r1.f15467c, composer, 805306374, 510);
            composer.endNode();
            if (ComposerKt.isTraceInProgress()) {
