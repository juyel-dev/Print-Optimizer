...
public final class Ue implements f {

    /* JADX INFO: renamed from: o, reason: collision with root package name */
    public final /* synthetic */ MutableState f14503o;

    public Ue(MutableState mutableState) {
        this.f14503o = mutableState;
    }
    ...
    public final Object invoke(Object obj, Object obj2, Object obj3) {
        ...
        if ((i5 & 19) == 18 && composer2.getSkipping()) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(738524385, i5, -1, "com.notescrafter.ui.screens.ToDoScreen.<anonymous>.<anonymous>.<anonymous>.<anonymous>.<anonymous>.<anonymous>.<anonymous>.<anonymous>.<anonymous> (ToDoScreen.kt:270)");
            }
            ...
            composer2.startReplaceGroup(1335588547);
            if (((String) this.f14503o.getValue()).length() == 0) {
                composer = composer2;
                TextKt.m2432Text4IGK_g("Add a new task...", (Modifier) null, Color.Companion.m3957getGray0d7_KjU(), TextUnitKt.getSp(14), (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (c) null, (TextStyle) null, composer, 3462, 0, 131058);
            } else {
                composer = composer2;
            }
