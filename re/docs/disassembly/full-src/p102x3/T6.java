...
public final class T6 implements f {

    /* JADX INFO: renamed from: o, reason: collision with root package name */
    public final /* synthetic */ MutableState f14450o;

    public T6(MutableState mutableState) {
        this.f14450o = mutableState;
    }
    ...
    public final Object invoke(Object obj, Object obj2, Object obj3) {
        ...
        if ((iIntValue & 17) == 16 && composer.getSkipping()) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1977309872, iIntValue, -1, "com.notescrafter.ui.screens.PdfAddPageNumbersScreen.<anonymous>.<anonymous>.<anonymous>.<anonymous> (PdfAddPageNumbersScreen.kt:1025)");
            }
            ...
            float f5 = 12;
            float f6 = f5;
            TextKt.m2432Text4IGK_g("Number Format Style", PaddingKt.m672paddingqDBjuR0$default(SizeKt.fillMaxWidth$default(companion, 0.0f, 1, null), 0.0f, 0.0f, 0.0f, Dp.m6403constructorimpl(f5), 7, null), j5, 0L, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (c) null, textStyleM5917copyp1EtxEg, composer, 438, 0, 65528);
            Modifier modifierFillMaxWidth$default = SizeKt.fillMaxWidth$default(companion, 0.0f, 1, null);
            int i6 = 0;
            Composer composer2 = composer;
            Modifier modifierHorizontalScroll$default = ScrollKt.horizontalScroll$default(modifierFillMaxWidth$default, ScrollKt.rememberScrollState(0, composer2, 0, 1), false, null, false, 14, null);
            int i7 = 6;
            ...
            Modifier modifierMaterializeModifier = ComposedModifierKt.materializeModifier(composer2, modifierHorizontalScroll$default);
            ...
            composer2.startReplaceGroup(1799299068);
            E6[] e6ArrValues = E6.values();
            int length = e6ArrValues.length;
            int i8 = 0;
            while (i8 < length) {
                E6 e6 = e6ArrValues[i8];
                MutableState mutableState = this.f14450o;
                int i9 = ((E6) mutableState.getValue()) == e6 ? i5 : i6;
                ...
                float f7 = f6;
                Modifier modifierE = b.e(f7, b.d(f7, companion3).then(i9 != 0 ? BackgroundKt.background$default(companion3, Brush.Companion.m3878linearGradientmHitzGk$default(Brush.Companion, v.S(Color.m3917boximpl(a.f15978a), Color.m3917boximpl(a.f15979b)), 0L, 0L, 0, 14, (Object) null), null, 0.0f, 6, null) : BackgroundKt.m207backgroundbw27NRU$default(companion3, Color.m3926copywmQWz5c$default(Color.Companion.m3964getWhite0d7_KjU(), 0.05f, 0.0f, 0.0f, 0.0f, 14, null), null, 2, null)), Dp.m6403constructorimpl(i5), i9 != 0 ? Color.Companion.m3962getTransparent0d7_KjU() : a.f15991r);
                composer2.startReplaceGroup(-1431618442);
                boolean zChanged = composer2.changed(e6);
                Object objRememberedValue = composer2.rememberedValue();
                if (zChanged || objRememberedValue == Composer.Companion.getEmpty()) {
                    objRememberedValue = new C2290i(10, e6, mutableState);
                    composer2.updateRememberedValue(objRememberedValue);
                }
                composer2.endReplaceGroup();
                Modifier modifierM669paddingVpY3zN4 = PaddingKt.m669paddingVpY3zN4(ClickableKt.m242clickableXHw0xAI$default(modifierE, false, null, null, (O3.a) objRememberedValue, 7, null), Dp.m6403constructorimpl(16), Dp.m6403constructorimpl(f7));
            ...
            composer4.endNode();
            if (b.q(24, Modifier.Companion, composer4, i7)) {
