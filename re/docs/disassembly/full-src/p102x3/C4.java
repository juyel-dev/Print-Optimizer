...
public final class C4 implements f {

    /* JADX INFO: renamed from: o, reason: collision with root package name */
    public final /* synthetic */ e f13839o;
    public final /* synthetic */ c p;

    public C4(e eVar, c cVar) {
        this.f13839o = eVar;
        this.p = cVar;
    }
    ...
    public final Object invoke(Object obj, Object obj2, Object obj3) {
        ...
        if ((iIntValue & 17) == 16 && composer.getSkipping()) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(2142249278, iIntValue, -1, "com.notescrafter.ui.screens.EnhanceScreen.<anonymous>.<anonymous>.<anonymous>.<anonymous> (EnhanceScreen.kt:449)");
            }
            ...
            Z4.i("Add Page Numbers", composer, 6);
            float f5 = 8;
            ...
            final e eVar = this.f13839o;
            boolean z3 = !eVar.getAddPageNumbers();
            composer.startReplaceGroup(-473405241);
            final c cVar = this.p;
            boolean zChanged = composer.changed(cVar) | composer.changed(eVar);
            Object objRememberedValue = composer.rememberedValue();
            if (zChanged || objRememberedValue == Composer.Companion.getEmpty()) {
                objRememberedValue = new a() { // from class: x3.B4
                    @Override // O3.a
                    public final Object invoke() {
                        switch (i6) {
                            case 0:
                                cVar.invoke(e.copy$default(eVar, null, null, null, 0, 0, false, false, 63, null));
                                break;
                            default:
                                cVar.invoke(e.copy$default(eVar, null, null, null, 0, 0, false, true, 63, null));
                                break;
                        }
                        return B3.o.f154a;
                    }
            ...
            boolean addPageNumbers = eVar.getAddPageNumbers();
            composer.startReplaceGroup(-473399802);
            boolean zChanged2 = composer.changed(cVar) | composer.changed(eVar);
            Object objRememberedValue2 = composer.rememberedValue();
            if (zChanged2 || objRememberedValue2 == Composer.Companion.getEmpty()) {
                objRememberedValue2 = new a() { // from class: x3.B4
                    @Override // O3.a
                    public final Object invoke() {
                        switch (i5) {
                            case 0:
            ...
            composer.endReplaceGroup();
            Z4.h("Yes", addPageNumbers, (a) objRememberedValue2, RowScope.weight$default(rowScopeInstance, companion, 1.0f, false, 2, null), composer, 6, 0);
