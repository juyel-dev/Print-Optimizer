...
public final class E7 implements f {

    /* JADX INFO: renamed from: o, reason: collision with root package name */
    public final /* synthetic */ MutableState f13912o;
    public final /* synthetic */ MutableState p;
    public final /* synthetic */ MutableState q;

    /* JADX INFO: renamed from: r, reason: collision with root package name */
    public final /* synthetic */ MutableState f13913r;

    /* JADX INFO: renamed from: s, reason: collision with root package name */
    public final /* synthetic */ MutableState f13914s;
    public final /* synthetic */ MutableState t;
    public final /* synthetic */ Context u;

    /* JADX INFO: renamed from: v, reason: collision with root package name */
    public final /* synthetic */ MutableState f13915v;

    /* JADX INFO: renamed from: w, reason: collision with root package name */
    public final /* synthetic */ MutableState f13916w;

    /* JADX INFO: renamed from: x, reason: collision with root package name */
    public final /* synthetic */ MutableState f13917x;

    public E7(Context context, MutableState mutableState, MutableState mutableState2, MutableState mutableState3, MutableState mutableState4, MutableState mutableState5, MutableState mutableState6, MutableState mutableState7, MutableState mutableState8, MutableState mutableState9) {
        this.f13912o = mutableState;
        this.p = mutableState2;
        this.q = mutableState3;
        this.f13913r = mutableState4;
        this.f13914s = mutableState5;
        this.t = mutableState6;
        this.u = context;
        this.f13915v = mutableState7;
        this.f13916w = mutableState8;
        this.f13917x = mutableState9;
    }
    ...
    public final Object invoke(Object obj, Object obj2, Object obj3) {
        ...
        if ((iIntValue & 17) == 16 && composer.getSkipping()) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(66498537, iIntValue, -1, "com.notescrafter.ui.screens.PdfCropScreen.<anonymous>.<anonymous>.<anonymous>.<anonymous> (PdfCropScreen.kt:404)");
            }
            ...
            MutableState mutableState = this.f13913r;
            MutableState mutableState2 = this.f13914s;
            MutableState mutableState3 = this.f13912o;
            j.a(modifierM672paddingqDBjuR0$default, 0L, jM3926copywmQWz5c$default, 0.0f, null, ComposableLambdaKt.rememberComposableLambda(332144814, true, new D7(mutableState3, this.p, this.q, mutableState, mutableState2, this.t, this.u), composer, 54), composer, 196998, 26);
            SpacerKt.Spacer(SizeKt.m699height3ABfNKs(companion, Dp.m6403constructorimpl(32)), composer, 6);
            composer.startReplaceGroup(1987174365);
            Object objRememberedValue = composer.rememberedValue();
            if (objRememberedValue == Composer.Companion.getEmpty()) {
                objRememberedValue = new C2527j7(this.f13915v, this.f13916w, mutableState3, this.f13917x, 1);
                composer.updateRememberedValue(objRememberedValue);
            }
            composer.endReplaceGroup();
            ButtonKt.TextButton((a) objRememberedValue, null, false, null, null, null, null, null, null, X0.f14620d, composer, 805306374, 510);
            composer.endNode();
            if (ComposerKt.isTraceInProgress()) {
