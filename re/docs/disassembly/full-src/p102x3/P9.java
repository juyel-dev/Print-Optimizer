...
import androidx.compose.material.icons.outlined.PhotoSizeSelectLargeKt;
import androidx.compose.material.icons.outlined.PhotoSizeSelectSmallKt;
...
public final class P9 implements f {

    /* JADX INFO: renamed from: o, reason: collision with root package name */
    public final /* synthetic */ MutableState f14292o;

    public P9(MutableState mutableState) {
        this.f14292o = mutableState;
    }
    ...
    public final Object invoke(Object obj, Object obj2, Object obj3) {
        ...
        if ((iIntValue & 17) == 16 && composer.getSkipping()) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1505256745, iIntValue, -1, "com.notescrafter.ui.screens.PdfToJpgScreen.<anonymous>.<anonymous>.<anonymous>.<anonymous> (PdfToJpgScreen.kt:830)");
            }
            ...
            float f5 = 12;
            float f6 = f5;
            TextKt.m2432Text4IGK_g("Image Quality / Resolution", PaddingKt.m672paddingqDBjuR0$default(SizeKt.fillMaxWidth$default(companion, 0.0f, 1, null), 0.0f, 0.0f, 0.0f, Dp.m6403constructorimpl(f5), 7, null), j5, 0L, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (c) null, textStyleM5917copyp1EtxEg, composer, 438, 0, 65528);
            int i5 = 1;
            ...
            composer2.startReplaceGroup(-420718754);
            Y3 y4 = Y3.LOW;
            Icons.Outlined outlined = Icons.Outlined.INSTANCE;
            for (m mVar : v.S(new m(y4, "72 DPI\n(Low Size)", PhotoSizeSelectSmallKt.getPhotoSizeSelectSmall(outlined)), new m(Y3.MEDIUM, "150 DPI\n(Balanced)", PhotoSizeSelectLargeKt.getPhotoSizeSelectLarge(outlined)), new m(Y3.HIGH, "300 DPI\n(High Res)", HdKt.getHd(outlined)))) {
                Y3 y5 = (Y3) mVar.f152o;
                String str = (String) mVar.p;
                ImageVector imageVector = (ImageVector) mVar.q;
                MutableState mutableState = this.f14292o;
                ?? r9 = ((Y3) mutableState.getValue()) == y5 ? i5 : r10;
                ...
                composer2.startReplaceGroup(-1839472839);
                boolean zChanged = composer2.changed(y5);
                Object objRememberedValue = composer2.rememberedValue();
                if (zChanged || objRememberedValue == Composer.Companion.getEmpty()) {
                    objRememberedValue = new C2290i(15, y5, mutableState);
