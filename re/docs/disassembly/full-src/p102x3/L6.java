...
public final class L6 implements f {
    ...
    public final /* synthetic */ MutableState f14157o;
    public final /* synthetic */ MutableState p;
    public final /* synthetic */ MutableState q;

    /* JADX INFO: renamed from: r, reason: collision with root package name */
    public final /* synthetic */ MutableState f14158r;

    /* JADX INFO: renamed from: s, reason: collision with root package name */
    public final /* synthetic */ MutableState f14159s;
    public final /* synthetic */ MutableState t;
    public final /* synthetic */ MutableState u;

    /* JADX INFO: renamed from: v, reason: collision with root package name */
    public final /* synthetic */ Context f14160v;

    /* JADX INFO: renamed from: w, reason: collision with root package name */
    public final /* synthetic */ MutableState f14161w;

    /* JADX INFO: renamed from: x, reason: collision with root package name */
    public final /* synthetic */ MutableState f14162x;

    public L6(Context context, MutableState mutableState, MutableState mutableState2, MutableState mutableState3, MutableState mutableState4, MutableState mutableState5, MutableState mutableState6, MutableState mutableState7, MutableState mutableState8, MutableState mutableState9) {
        this.f14157o = mutableState;
        this.p = mutableState2;
        this.q = mutableState3;
        this.f14158r = mutableState4;
        this.f14159s = mutableState5;
        this.t = mutableState6;
        this.u = mutableState7;
        this.f14160v = context;
        this.f14161w = mutableState8;
        this.f14162x = mutableState9;
    }
    ...
    public final Object invoke(Object obj, Object obj2, Object obj3) {
        ...
        if ((iIntValue & 17) == 16 && composer.getSkipping()) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(1836813205, iIntValue, -1, "com.notescrafter.ui.screens.PdfAddPageNumbersScreen.<anonymous>.<anonymous>.<anonymous>.<anonymous> (PdfAddPageNumbersScreen.kt:407)");
            }
            ...
            MutableState mutableState = this.f14159s;
            MutableState mutableState2 = this.t;
            MutableState mutableState3 = this.f14157o;
            j.a(modifierM672paddingqDBjuR0$default, 0L, jM3926copywmQWz5c$default, 0.0f, null, ComposableLambdaKt.rememberComposableLambda(-571611174, true, new K6(mutableState3, this.p, this.q, this.f14158r, mutableState, mutableState2, this.u, this.f14160v), composer, 54), composer, 196998, 26);
            SpacerKt.Spacer(SizeKt.m699height3ABfNKs(companion, Dp.m6403constructorimpl(32)), composer, 6);
            composer.startReplaceGroup(1798551478);
            Object objRememberedValue = composer.rememberedValue();
            if (objRememberedValue == Composer.Companion.getEmpty()) {
                objRememberedValue = new P3(2, this.f14161w, mutableState3, this.f14162x);
                composer.updateRememberedValue(objRememberedValue);
            }
            composer.endReplaceGroup();
            ButtonKt.TextButton((a) objRememberedValue, null, false, null, null, null, null, null, null, E0.f13896d, composer, 805306374, 510);
            composer.endNode();
            if (ComposerKt.isTraceInProgress()) {
