...
/* JADX INFO: renamed from: x3.y9, reason: case insensitive filesystem */
/* JADX INFO: loaded from: classes2.dex */
public final class C2768y9 implements e {

    /* JADX INFO: renamed from: o, reason: collision with root package name */
    public final /* synthetic */ State f15779o;
    public final /* synthetic */ State p;
    public final /* synthetic */ MutableState q;

    /* JADX INFO: renamed from: r, reason: collision with root package name */
    public final /* synthetic */ MutableState f15780r;

    /* JADX INFO: renamed from: s, reason: collision with root package name */
    public final /* synthetic */ MutableState f15781s;
    public final /* synthetic */ MutableState t;

    public C2768y9(State state, State state2, MutableState mutableState, MutableState mutableState2, MutableState mutableState3, MutableState mutableState4) {
        this.f15779o = state;
        this.p = state2;
        this.q = mutableState;
        this.f15780r = mutableState2;
        this.f15781s = mutableState3;
    ...
    public final Object invoke(Object obj, Object obj2) {
        ...
        if ((iIntValue & 3) == 2 && composer.getSkipping()) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(1262199162, iIntValue, -1, "com.notescrafter.ui.screens.PdfSplitScreen.<anonymous>.<anonymous> (PdfSplitScreen.kt:970)");
            }
            ...
            Modifier modifierClip = ClipKt.clip(SizeKt.m713size3ABfNKs(companion, Dp.m6403constructorimpl(((Number) this.f15779o.getValue()).floatValue() * 80)), RoundedCornerShapeKt.getCircleShape());
            ...
            IconKt.m1877Iconww6aTOc(callSplit, (String) null, SizeKt.m713size3ABfNKs(companion, Dp.m6403constructorimpl(28)), companion5.m3964getWhite0d7_KjU(), composer, 3504, 0);
            ...
            String strM = p035i0.a.m("Processing File ", " of ", ((Number) this.f15780r.getValue()).intValue(), ((Number) this.f15781s.getValue()).intValue());
            TextStyle bodyMedium = materialTheme.getTypography(composer, i5).getBodyMedium();
            long j7 = p107y3.a.p;
            TextKt.m2432Text4IGK_g(strM, (Modifier) null, j7, 0L, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (c) null, bodyMedium, composer, 384, 0, 65530);
            ...
            SpacerKt.Spacer(SizeKt.m699height3ABfNKs(companion, Dp.m6403constructorimpl(f7)), composer, 6);
            TextKt.m2432Text4IGK_g(androidx.compose.foundation.text.modifiers.a.k((int) (((Number) mutableState.getValue()).floatValue() * 100), "%"), (Modifier) null, j7, 0L, (FontStyle) null, companion6.getBold(), (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (c) null, materialTheme.getTypography(composer, i5).getBodyMedium(), composer, 196992, 0, 65498);
            composer.endNode();
            if (ComposerKt.isTraceInProgress()) {
