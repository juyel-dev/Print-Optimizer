...
public final class J4 implements f {
    ...
    public final /* synthetic */ e f14104o;
    public final /* synthetic */ c p;

    public J4(e eVar, c cVar) {
        this.f14104o = eVar;
        this.p = cVar;
    }
    ...
    public final Object invoke(Object obj, Object obj2, Object obj3) {
        ...
        if ((iIntValue & 17) == 16 && composer.getSkipping()) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(1142525242, iIntValue, -1, "com.notescrafter.ui.screens.EnhanceScreen.<anonymous>.<anonymous>.<anonymous>.<anonymous> (EnhanceScreen.kt:345)");
            }
            ...
            composer.startReplaceGroup(-473591535);
            for (p087u3.a aVar : p087u3.a.getEntries()) {
                String str = aVar == p087u3.a.ORIGINAL ? "Original" : "A4";
                e eVar = this.f14104o;
                boolean z3 = eVar.getDocumentSize() == aVar;
                composer.startReplaceGroup(-843337592);
                ...
                if (zChanged2 || objRememberedValue == Composer.Companion.getEmpty()) {
                    objRememberedValue = new C2306q(aVar, cVar, eVar, 2);
                    composer.updateRememberedValue(objRememberedValue);
                }
                composer.endReplaceGroup();
                Z4.h(str, z3, (a) objRememberedValue, RowScope.weight$default(rowScopeInstance, Modifier.Companion, 1.0f, false, 2, null), composer, 0, 0);
            }
            composer.endReplaceGroup();
            composer.endNode();
            composer.endNode();
