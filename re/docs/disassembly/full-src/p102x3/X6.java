...
public final class X6 implements e {

    /* JADX INFO: renamed from: o, reason: collision with root package name */
    public final /* synthetic */ State f14646o;
    public final /* synthetic */ State p;
    public final /* synthetic */ MutableState q;

    /* JADX INFO: renamed from: r, reason: collision with root package name */
    public final /* synthetic */ MutableState f14647r;

    public X6(State state, State state2, MutableState mutableState, MutableState mutableState2) {
        this.f14646o = state;
        this.p = state2;
        this.q = mutableState;
        this.f14647r = mutableState2;
    }
    ...
    public final Object invoke(Object obj, Object obj2) {
        ...
        if ((iIntValue & 3) == 2 && composer.getSkipping()) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1507319980, iIntValue, -1, "com.notescrafter.ui.screens.PdfAddPageNumbersScreen.<anonymous>.<anonymous> (PdfAddPageNumbersScreen.kt:1193)");
            }
            ...
            Modifier modifierClip = ClipKt.clip(SizeKt.m713size3ABfNKs(companion, Dp.m6403constructorimpl(((Number) this.f14646o.getValue()).floatValue() * 80)), RoundedCornerShapeKt.getCircleShape());
            ...
            IconKt.m1877Iconww6aTOc(formatListNumbered, (String) null, SizeKt.m713size3ABfNKs(companion, Dp.m6403constructorimpl(28)), companion5.m3964getWhite0d7_KjU(), composer, 3504, 0);
            ...
            composer.startReplaceGroup(775204732);
            Object objRememberedValue = composer.rememberedValue();
            Object empty = Composer.Companion.getEmpty();
            MutableState mutableState = this.f14647r;
            if (objRememberedValue == empty) {
                objRememberedValue = new O6(1, mutableState);
