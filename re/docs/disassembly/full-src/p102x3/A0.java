...
public final class A0 implements f {
    ...
    public static final A0 f13726o = new A0();
    ...
    public final Object invoke(Object obj, Object obj2, Object obj3) {
        ...
        if ((iIntValue & 17) == 16 && composer.getSkipping()) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(323635513, iIntValue, -1, "com.notescrafter.ui.screens.ComposableSingletons$PdfAddPageNumbersScreenKt.lambda-6.<anonymous> (PdfAddPageNumbersScreen.kt:742)");
            }
            ...
            AbstractC2447e7.d("01", DescriptionKt.getDescription(outlined), "Select PDF Document", "Choose the PDF file you want to add page numbers to.", composer, 3462);
            AbstractC2447e7.d("02", TuneKt.getTune(outlined), "Configure Style & Position", "Select numbering format (plain, Roman, page prefix), layout position, size, and skip settings.", composer, 3462);
            AbstractC2447e7.d("03", FormatListNumberedKt.getFormatListNumbered(outlined), "Process & Save", "Click 'Add Page Numbers' to apply settings and download the updated PDF file.", composer, 3462);
            composer.endNode();
            if (ComposerKt.isTraceInProgress()) {
