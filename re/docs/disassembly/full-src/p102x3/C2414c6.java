...
/* JADX INFO: renamed from: x3.c6, reason: case insensitive filesystem */
/* JADX INFO: loaded from: classes2.dex */
public final class C2414c6 implements e {

    /* JADX INFO: renamed from: o, reason: collision with root package name */
    public final /* synthetic */ State f14864o;
    public final /* synthetic */ State p;
    public final /* synthetic */ MutableState q;

    /* JADX INFO: renamed from: r, reason: collision with root package name */
    public final /* synthetic */ MutableState f14865r;

    public C2414c6(State state, State state2, MutableState mutableState, MutableState mutableState2) {
        this.f14864o = state;
        this.p = state2;
        this.q = mutableState;
        this.f14865r = mutableState2;
    }
    ...
    public final Object invoke(Object obj, Object obj2) {
        ...
        if ((iIntValue & 3) == 2 && composer.getSkipping()) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1220696518, iIntValue, -1, "com.notescrafter.ui.screens.JpgToPdfScreen.<anonymous>.<anonymous> (JpgToPdfScreen.kt:1028)");
            }
            ...
            Modifier modifierClip = ClipKt.clip(SizeKt.m713size3ABfNKs(companion, Dp.m6403constructorimpl(((Number) this.f14864o.getValue()).floatValue() * 80)), RoundedCornerShapeKt.getCircleShape());
            ...
            ImageVector pictureAsPdf = PictureAsPdfKt.getPictureAsPdf(Icons.Outlined.INSTANCE);
            Color.Companion companion5 = Color.Companion;
            IconKt.m1877Iconww6aTOc(pictureAsPdf, (String) null, SizeKt.m713size3ABfNKs(companion, Dp.m6403constructorimpl(28)), companion5.m3964getWhite0d7_KjU(), composer, 3504, 0);
            ...
            composer.startReplaceGroup(-1773610914);
            Object objRememberedValue = composer.rememberedValue();
            Object empty = Composer.Companion.getEmpty();
            MutableState mutableState = this.f14865r;
            if (objRememberedValue == empty) {
                objRememberedValue = new I(26, mutableState);
