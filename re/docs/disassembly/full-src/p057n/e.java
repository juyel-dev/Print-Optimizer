...
public abstract /* synthetic */ class e {
    ...
    public static List c(float f5, float f6, float f7, float f8, float f9) {
        PathBuilder pathBuilder = new PathBuilder();
        pathBuilder.moveTo(f5, f6);
        pathBuilder.horizontalLineToRelative(f7);
        pathBuilder.verticalLineToRelative(f8);
    ...
    public static List e(PathBuilder pathBuilder, float f5, float f6, float f7, float f8) {
        pathBuilder.reflectiveCurveTo(f5, f6, f7, f8);
        pathBuilder.close();
        return pathBuilder.getNodes();
    }
    ...
    public static List i(PathBuilder pathBuilder, float f5, float f6, float f7) {
        pathBuilder.verticalLineToRelative(f5);
        pathBuilder.horizontalLineTo(f6);
        pathBuilder.verticalLineTo(f7);
        pathBuilder.close();
    ...
    public static List j(PathBuilder pathBuilder, float f5, float f6, float f7, float f8) {
        pathBuilder.horizontalLineToRelative(f5);
        pathBuilder.verticalLineToRelative(f6);
    ...
    public static void k(PathBuilder pathBuilder, float f5, float f6, float f7) {
        pathBuilder.verticalLineToRelative(f5);
    ...
    public static PathBuilder q(float f5, float f6, float f7, float f8, float f9) {
        PathBuilder pathBuilder = new PathBuilder();
        pathBuilder.moveTo(f5, f6);
        pathBuilder.lineToRelative(f7, f8);
    ...
    public static PathBuilder u(float f5, float f6, float f7, float f8, float f9) {
        PathBuilder pathBuilder = new PathBuilder();
        pathBuilder.moveTo(f5, f6);
        pathBuilder.verticalLineToRelative(f7);
        pathBuilder.horizontalLineTo(f8);
    ...
    public static void v(PathBuilder pathBuilder, float f5, float f6, float f7) {
        pathBuilder.verticalLineTo(f5);
        pathBuilder.horizontalLineToRelative(f6);
        pathBuilder.verticalLineTo(f7);
        pathBuilder.close();
