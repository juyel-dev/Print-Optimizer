...
public final class T1 implements f {
    ...
    public static final T1 f14443o = new T1();
    ...
    public final Object invoke(Object obj, Object obj2, Object obj3) {
        ...
        if ((iIntValue & 17) == 16 && composer.getSkipping()) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-288718305, iIntValue, -1, "com.notescrafter.ui.screens.ComposableSingletons$PdfToJpgScreenKt.lambda-7.<anonymous> (PdfToJpgScreen.kt:695)");
            }
            ...
            Z9.c("01", DescriptionKt.getDescription(outlined), "Select PDF File", "Choose the PDF document from your device that you want to convert into images.", composer, 3462);
            Z9.c("02", PhotoSizeSelectLargeKt.getPhotoSizeSelectLarge(outlined), "Select Resolution", "Pick low (72 DPI), balanced (150 DPI), or high resolution (300 DPI) for JPG images.", composer, 3462);
            Z9.c("03", ImageKt.getImage(outlined), "Convert & Share", "Download converted JPEG files, preview them individually, or export them as a single ZIP.", composer, 3462);
            composer.endNode();
            if (ComposerKt.isTraceInProgress()) {
