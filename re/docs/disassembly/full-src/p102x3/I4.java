...
public final class I4 implements f {

    /* JADX INFO: renamed from: o, reason: collision with root package name */
    public final /* synthetic */ e f14058o;
    public final /* synthetic */ c p;

    public I4(e eVar, c cVar) {
        this.f14058o = eVar;
        this.p = cVar;
    }
    ...
    public final Object invoke(Object obj, Object obj2, Object obj3) {
        ...
        if ((iIntValue & 17) == 16 && composer.getSkipping()) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(1966336057, iIntValue, -1, "com.notescrafter.ui.screens.EnhanceScreen.<anonymous>.<anonymous>.<anonymous>.<anonymous> (EnhanceScreen.kt:323)");
            }
            ...
            Z4.i("Output Quality", composer, 6);
            b.m(12, companion, composer, 6);
            MeasurePolicy measurePolicyColumnMeasurePolicy2 = ColumnKt.columnMeasurePolicy(arrangement.m548spacedBy0680j_4(Dp.m6403constructorimpl(8)), companion2.getStart(), composer, 6);
            ...
            composer.startReplaceGroup(-473629909);
            for (d dVar : d.getEntries()) {
                ...
                e eVar = this.f14058o;
                boolean z3 = eVar.getQuality() == dVar;
                composer.startReplaceGroup(-843373064);
                boolean zChanged = composer.changed(dVar);
                c cVar = this.p;
                ...
                if (zChanged2 || objRememberedValue == Composer.Companion.getEmpty()) {
                    objRememberedValue = new C2306q(dVar, cVar, eVar, 1);
                    composer.updateRememberedValue(objRememberedValue);
                }
                composer.endReplaceGroup();
                Z4.h(lowerCase, z3, (a) objRememberedValue, null, composer, 0, 8);
            }
            composer.endReplaceGroup();
            composer.endNode();
            composer.endNode();
