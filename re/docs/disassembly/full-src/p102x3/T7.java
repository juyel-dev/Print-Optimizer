...
public final class T7 implements e {

    /* JADX INFO: renamed from: o, reason: collision with root package name */
    public final /* synthetic */ State f14451o;
    public final /* synthetic */ State p;
    public final /* synthetic */ MutableState q;

    /* JADX INFO: renamed from: r, reason: collision with root package name */
    public final /* synthetic */ MutableState f14452r;

    public T7(State state, State state2, MutableState mutableState, MutableState mutableState2) {
        this.f14451o = state;
        this.p = state2;
        this.q = mutableState;
        this.f14452r = mutableState2;
    }
    ...
    public final Object invoke(Object obj, Object obj2) {
        ...
        if ((iIntValue & 3) == 2 && composer.getSkipping()) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1074964184, iIntValue, -1, "com.notescrafter.ui.screens.PdfCropScreen.<anonymous>.<anonymous> (PdfCropScreen.kt:1049)");
            }
            ...
            Modifier modifierClip = ClipKt.clip(SizeKt.m713size3ABfNKs(companion, Dp.m6403constructorimpl(((Number) this.f14451o.getValue()).floatValue() * 80)), RoundedCornerShapeKt.getCircleShape());
            ...
            ImageVector crop = CropKt.getCrop(Icons.Outlined.INSTANCE);
            Color.Companion companion5 = Color.Companion;
            IconKt.m1877Iconww6aTOc(crop, (String) null, SizeKt.m713size3ABfNKs(companion, Dp.m6403constructorimpl(28)), companion5.m3964getWhite0d7_KjU(), composer, 3504, 0);
            ...
            composer.startReplaceGroup(-1391848142);
            Object objRememberedValue = composer.rememberedValue();
            Object empty = Composer.Companion.getEmpty();
            MutableState mutableState = this.f14452r;
            if (objRememberedValue == empty) {
                objRememberedValue = new O6(8, mutableState);
