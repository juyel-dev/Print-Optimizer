...
/* JADX INFO: renamed from: x3.m7, reason: case insensitive filesystem */
/* JADX INFO: loaded from: classes2.dex */
public final class C2575m7 implements f {

    /* JADX INFO: renamed from: o, reason: collision with root package name */
    public final /* synthetic */ int f15310o;
    public final /* synthetic */ Context p;
    public final /* synthetic */ MutableState q;

    /* JADX INFO: renamed from: r, reason: collision with root package name */
    public final /* synthetic */ MutableState f15311r;

    /* JADX INFO: renamed from: s, reason: collision with root package name */
    public final /* synthetic */ MutableState f15312s;
    public final /* synthetic */ MutableState t;
    public final /* synthetic */ MutableState u;

    /* JADX INFO: renamed from: v, reason: collision with root package name */
    public final /* synthetic */ MutableState f15313v;

    public C2575m7(int i5, Context context, MutableState mutableState, MutableState mutableState2, MutableState mutableState3, MutableState mutableState4, MutableState mutableState5, MutableState mutableState6) {
        this.f15310o = i5;
        this.p = context;
        this.q = mutableState;
        this.f15311r = mutableState2;
        this.f15312s = mutableState3;
        this.t = mutableState4;
        this.u = mutableState5;
        this.f15313v = mutableState6;
    }
    ...
    public final Object invoke(Object obj, Object obj2, Object obj3) {
        ...
        if ((iIntValue & 17) == 16 && composer.getSkipping()) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(1476623301, iIntValue, -1, "com.notescrafter.ui.screens.PdfCompressScreen.<anonymous>.<anonymous>.<anonymous>.<anonymous> (PdfCompressScreen.kt:356)");
            }
            Modifier.Companion companion = Modifier.Companion;
            float f5 = 16;
            Modifier modifierM670paddingVpY3zN4$default = PaddingKt.m670paddingVpY3zN4$default(SizeKt.fillMaxWidth$default(companion, 0.0f, 1, null), 0.0f, Dp.m6403constructorimpl(f5), 1, null);
            ...
            if (str == null) {
                ...
                long j7 = p107y3.a.f15985j;
                obj4 = null;
                r14 = 1;
                j.a(modifierM672paddingqDBjuR0$default, Color.m3926copywmQWz5c$default(j7, 0.06f, 0.0f, 0.0f, 0.0f, 14, null), Color.m3926copywmQWz5c$default(j7, 0.2f, 0.0f, 0.0f, 0.0f, 14, null), 0.0f, null, ComposableLambdaKt.rememberComposableLambda(1956419378, true, new C2543k7(str), composer, 54), composer, 197046, 24);
            }
            composer.endReplaceGroup();
            Modifier modifierFillMaxWidth$default = SizeKt.fillMaxWidth$default(companion, 0.0f, r14, obj4);
            int i6 = this.f15310o;
            long jM3926copywmQWz5c$default = i6 > 0 ? Color.m3926copywmQWz5c$default(j5, 0.15f, 0.0f, 0.0f, 0.0f, 14, null) : p107y3.a.t;
            MutableState mutableState3 = this.f15311r;
            j.a(modifierFillMaxWidth$default, 0L, jM3926copywmQWz5c$default, 0.0f, null, ComposableLambdaKt.rememberComposableLambda(-871213174, r14, new C2559l7(i6, mutableState3, this.f15312s, this.t), composer, 54), composer, 196614, 26);
            SpacerKt.Spacer(SizeKt.m699height3ABfNKs(companion, Dp.m6403constructorimpl(32)), composer, 6);
            composer.startReplaceGroup(835773964);
            Context context = this.p;
            boolean zChangedInstance = composer.changedInstance(context);
            Object objRememberedValue = composer.rememberedValue();
            if (zChangedInstance || objRememberedValue == Composer.Companion.getEmpty()) {
                objRememberedValue = new M5(context, mutableState3, 4);
                composer.updateRememberedValue(objRememberedValue);
            }
            composer.endReplaceGroup();
            q.a("Open PDF", (a) objRememberedValue, SizeKt.fillMaxWidth$default(companion, 0.0f, r14, null), null, false, false, composer, 390, 56);
            ...
            BorderStroke borderStrokeM236BorderStrokecXLIe8U = BorderStrokeKt.m236BorderStrokecXLIe8U(Dp.m6403constructorimpl(f6), p107y3.a.f15991r);
            ButtonColors buttonColorsM1530outlinedButtonColorsro_MJ88 = ButtonDefaults.INSTANCE.m1530outlinedButtonColorsro_MJ88(0L, j6, 0L, 0L, composer, (ButtonDefaults.$stable << 12) | 48, 13);
            Modifier modifierM699height3ABfNKs = SizeKt.m699height3ABfNKs(SizeKt.fillMaxWidth$default(companion, 0.0f, r14, null), Dp.m6403constructorimpl(56));
            composer.startReplaceGroup(835807654);
            ...
            if (zChangedInstance2 || objRememberedValue2 == Composer.Companion.getEmpty()) {
                ...
                objRememberedValue2 = new M5(context, mutableState, 5);
            ...
            ButtonKt.OutlinedButton((a) objRememberedValue2, modifierM699height3ABfNKs, false, roundedCornerShapeM955RoundedCornerShape0680j_4, buttonColorsM1530outlinedButtonColorsro_MJ88, null, borderStrokeM236BorderStrokecXLIe8U, null, null, N0.f14210b, composer, 806879280, 420);
            SpacerKt.Spacer(SizeKt.m699height3ABfNKs(companion, Dp.m6403constructorimpl(f5)), composer, 6);
            composer.startReplaceGroup(835856823);
            Object objRememberedValue3 = composer.rememberedValue();
            if (objRememberedValue3 == Composer.Companion.getEmpty()) {
                objRememberedValue3 = new C2527j7(this.u, mutableState4, this.f15313v, mutableState2, 0);
                composer.updateRememberedValue(objRememberedValue3);
            }
            composer.endReplaceGroup();
            ButtonKt.TextButton((a) objRememberedValue3, null, false, null, null, null, null, null, null, N0.f14211c, composer, 805306374, 510);
            composer.endNode();
            if (ComposerKt.isTraceInProgress()) {
