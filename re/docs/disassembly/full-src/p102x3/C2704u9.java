...
/* JADX INFO: renamed from: x3.u9, reason: case insensitive filesystem */
/* JADX INFO: loaded from: classes2.dex */
public final class C2704u9 implements f {

    /* JADX INFO: renamed from: o, reason: collision with root package name */
    public final /* synthetic */ MutableState f15606o;

    public C2704u9(MutableState mutableState) {
        this.f15606o = mutableState;
    }
    ...
    public final Object invoke(Object obj, Object obj2, Object obj3) {
        ...
        if ((iIntValue & 17) == 16 && composer.getSkipping()) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1529150633, iIntValue, -1, "com.notescrafter.ui.screens.PdfSplitScreen.<anonymous>.<anonymous>.<anonymous>.<anonymous> (PdfSplitScreen.kt:803)");
            }
            ...
            float f5 = 12;
            float f6 = f5;
            TextKt.m2432Text4IGK_g("Split Mode", PaddingKt.m672paddingqDBjuR0$default(SizeKt.fillMaxWidth$default(companion, 0.0f, 1, null), 0.0f, 0.0f, 0.0f, Dp.m6403constructorimpl(f5), 7, null), j5, 0L, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (c) null, textStyleM5917copyp1EtxEg, composer, 438, 0, 65528);
            int i5 = 1;
            ...
            composer2.startReplaceGroup(-2131127567);
            EnumC2677se enumC2677se = EnumC2677se.f15538o;
            Icons.Outlined outlined = Icons.Outlined.INSTANCE;
            for (m mVar : v.S(new m(enumC2677se, "Extract Pages", ContentCutKt.getContentCut(outlined)), new m(EnumC2677se.p, "Split All", GridViewKt.getGridView(outlined)), new m(EnumC2677se.q, "Every N Pages", RepeatKt.getRepeat(outlined)))) {
                EnumC2677se enumC2677se2 = (EnumC2677se) mVar.f152o;
                String str = (String) mVar.p;
                ImageVector imageVector = (ImageVector) mVar.q;
                MutableState mutableState = this.f15606o;
                ?? r9 = ((EnumC2677se) mutableState.getValue()) == enumC2677se2 ? i5 : r10;
                ...
                composer2.startReplaceGroup(-2144326322);
                boolean zChanged = composer2.changed(enumC2677se2);
                Object objRememberedValue = composer2.rememberedValue();
                if (zChanged || objRememberedValue == Composer.Companion.getEmpty()) {
                    objRememberedValue = new C2290i(14, enumC2677se2, mutableState);
