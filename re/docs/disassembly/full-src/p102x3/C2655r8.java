...
/* JADX INFO: renamed from: x3.r8, reason: case insensitive filesystem */
/* JADX INFO: loaded from: classes2.dex */
public final class C2655r8 implements e {

    /* JADX INFO: renamed from: o, reason: collision with root package name */
    public final /* synthetic */ State f15491o;
    public final /* synthetic */ State p;
    public final /* synthetic */ MutableState q;

    /* JADX INFO: renamed from: r, reason: collision with root package name */
    public final /* synthetic */ MutableState f15492r;

    public C2655r8(State state, State state2, MutableState mutableState, MutableState mutableState2) {
        this.f15491o = state;
        this.p = state2;
        this.q = mutableState;
        this.f15492r = mutableState2;
    }
    ...
    public final Object invoke(Object obj, Object obj2) {
        ...
        if ((iIntValue & 3) == 2 && composer.getSkipping()) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1385008036, iIntValue, -1, "com.notescrafter.ui.screens.PdfInvertScreen.<anonymous>.<anonymous> (PdfInvertScreen.kt:892)");
            }
            ...
            Modifier modifierClip = ClipKt.clip(SizeKt.m713size3ABfNKs(companion, Dp.m6403constructorimpl(((Number) this.f15491o.getValue()).floatValue() * 80)), RoundedCornerShapeKt.getCircleShape());
            ...
            ImageVector invertColors = InvertColorsKt.getInvertColors(Icons.Outlined.INSTANCE);
            Color.Companion companion5 = Color.Companion;
            IconKt.m1877Iconww6aTOc(invertColors, (String) null, SizeKt.m713size3ABfNKs(companion, Dp.m6403constructorimpl(28)), companion5.m3964getWhite0d7_KjU(), composer, 3504, 0);
            ...
            composer.startReplaceGroup(541573016);
            Object objRememberedValue = composer.rememberedValue();
            Object empty = Composer.Companion.getEmpty();
            MutableState mutableState = this.f15492r;
            if (objRememberedValue == empty) {
                objRememberedValue = new O6(9, mutableState);
