...
public abstract /* synthetic */ class a {
    ...
    public static List k(PathBuilder pathBuilder, float f5, float f6) {
        pathBuilder.horizontalLineTo(f5);
        pathBuilder.verticalLineTo(f6);
        pathBuilder.close();
        return pathBuilder.getNodes();
    ...
    public static List l(PathBuilder pathBuilder, float f5, float f6, float f7, float f8) {
        pathBuilder.lineToRelative(f5, f6);
        pathBuilder.lineTo(f7, f8);
        pathBuilder.close();
        return pathBuilder.getNodes();
    ...
    public static void m(PathBuilder pathBuilder, float f5, float f6, float f7) {
    ...
    public static List u(PathBuilder pathBuilder, float f5, float f6, float f7, float f8) {
        pathBuilder.lineToRelative(f5, f6);
        pathBuilder.lineToRelative(f7, f8);
        pathBuilder.close();
        return pathBuilder.getNodes();
    ...
    public static List x(PathBuilder pathBuilder, float f5, float f6, float f7, float f8) {
        pathBuilder.lineTo(f5, f6);
        pathBuilder.lineToRelative(f7, f8);
        pathBuilder.close();
        return pathBuilder.getNodes();
