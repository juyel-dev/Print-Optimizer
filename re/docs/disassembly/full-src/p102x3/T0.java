...
public final class T0 implements f {
    ...
    public static final T0 f14442o = new T0();
    ...
    public final Object invoke(Object obj, Object obj2, Object obj3) {
        ...
        if ((iIntValue & 17) == 16 && composer.getSkipping()) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(1877583757, iIntValue, -1, "com.notescrafter.ui.screens.ComposableSingletons$PdfCropScreenKt.lambda-6.<anonymous> (PdfCropScreen.kt:705)");
            }
            ...
            AbstractC2416c8.c("01", DescriptionKt.getDescription(outlined), "Select PDF Document", "Choose the PDF file you want to crop from your device storage.", composer, 3462);
            AbstractC2416c8.c("02", CropKt.getCrop(outlined), "Adjust Margins", "Specify margins in mm for top, bottom, left, and right using the preview.", composer, 3462);
            AbstractC2416c8.c("03", SaveKt.getSave(outlined), "Crop & Export", "Process your file instantly. Review and download or share your cropped PDF.", composer, 3462);
            composer.endNode();
            if (ComposerKt.isTraceInProgress()) {
